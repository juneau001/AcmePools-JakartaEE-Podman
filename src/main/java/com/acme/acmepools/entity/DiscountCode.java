...
public class DiscountCode implements Serializable {
    ...
    public @NotNull @Size(min = 1, max = 1) String getDiscountCode() {
        return discountCode;
    }

    public void setDiscountCode(@NotNull @Size(min = 1, max = 1) String discountCode) {
    ...
    public String toString() {
        return "com.acme.acmepools.entity.DiscountCode[ id=" + discountCode + " ]";
    }
