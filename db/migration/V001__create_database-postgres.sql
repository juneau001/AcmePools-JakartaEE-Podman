...
CREATE TABLE MICRO_MARKET (ZIP_CODE VARCHAR(10) NOT NULL, RADIUS DOUBLE PRECISION, AREA_LENGTH DOUBLE PRECISION, AREA_WIDTH DOUBLE PRECISION, PRIMARY KEY (ZIP_CODE));
